class OpportunitiesController < ApplicationController
  ...
  def upload
    ...
    if @csv.save
      ContactMailer.csv_upload_alert(@csv.file.url).deliver
      redirect_to upload_opportunities_path, notice: 'Your CSV file has been received. You will be notified by email when it has finished processing.'
    else
